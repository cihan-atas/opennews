...
import os
from routers import auth, news, podcast, users, categories, bookmarks, feed, rss, rss_reader, admin, read_later, settings as settings_router  # Routers klasöründen çekiyoruz
