...
const makeStyles = (colors) => StyleSheet.create({
  ...
  closeBtn: { width: 26, height: 26, borderRadius: 13, backgroundColor: colors.chip, alignItems: 'center', justifyContent: 'center' },
  progressTrack: { height: 4, borderRadius: 2, backgroundColor: colors.chip, marginBottom: 10, overflow: 'hidden' },
