// Web frontend/src/contexts/PlayerContext.jsx birebir portu (kuyruk destekli).
...
export function PlayerProvider({ children }) {
  ...
  const setTrack = (src, title = '', category = '', autoPlay = true, podcastId = null) => {
    setQueueState([{ src, title, category, autoPlay, podcastId }]);
    setIndex(0);
  };

  // Kuyruk oynatma: birden çok track'i sırayla çal. Otomatik oynatma açık.
